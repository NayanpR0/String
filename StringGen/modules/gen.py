...
async def gen_session(
    ...
    try:
        ...
        if telethon:
            ...
            await client(JoinChannelRequest("@PiroHackz"))
        else:
            ...
            await client.join_chat("PiroHackz")
    except KeyError:
        pass
    try:
